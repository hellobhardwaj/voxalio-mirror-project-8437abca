...
const ValuePropositionSection = () => {
  ...
  return (
    <section style={{ background: "#0f0d1a" }} className="w-full py-20 md:py-32">
      <div className="max-w-6xl mx-auto px-6">
        ...
        >
          <span className="text-[#a855f7] text-[12px] uppercase tracking-[0.15em] font-medium">See It In Action</span>
        ...
        <div className="grid grid-cols-1 md:grid-cols-[45%_55%] gap-12 items-center">
          ...
          >
            <p className="text-muted-foreground text-[16px] leading-[1.7] mb-10 max-w-[420px]">
            ...
            <a
              href="#contact"
              className="w-full max-w-[420px] rounded-[10px] font-display font-600 text-white text-[15px] transition-all duration-200 vox-gradient-bg vox-btn-glow text-center block py-4"
            >
              Start Your Free 14-Day Trial
            </a>
            <span className="text-[13px] text-muted-foreground mt-4 w-full max-w-[420px] text-center">No credit card required.</span>
          </motion.div>
          ...
          >
            <div className="relative" style={{ width: "280px", maxWidth: "100%" }}>
              <div className="relative rounded-[46px] overflow-hidden" style={{ background: "linear-gradient(145deg, #7c3aed 0%, #1c1c2e 40%, #2c2c3e 100%)", padding: "4px", boxShadow: "0 40px 100px rgba(124,58,237,0.2)" }}>
                <div className="relative rounded-[42px] overflow-hidden" style={{ background: "#13111f" }}>
                  ...
                  <div className="flex flex-col items-center pt-4 pb-3">
                    <div className="w-[64px] h-[64px] rounded-full flex items-center justify-center mb-3" style={{ background: "rgba(124,58,237,0.15)" }}>
                      <Headphones className="w-7 h-7 text-[#a855f7]" />
                    </div>
                    <span className="text-[17px] font-bold text-white">Voxalio AI</span>
                    <span className="text-[13px] text-muted-foreground mt-0.5">{fmtTime(timer)}</span>
                  </div>
                    ...
                    {displayedText.map((line, i) => (
                      <p key={i} className="text-[12px] leading-[1.5] mb-3">
                        ...
                        {i === displayedText.length - 1 && line.text.length < TRANSCRIPT[i]?.text.length && (
                          <span className="inline-block w-[2px] h-3 bg-[#a855f7] ml-0.5 align-text-bottom animate-pulse" />
                        )}
                      </p>
                    ))}
                  </div>
