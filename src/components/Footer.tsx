      ...
      <div className="max-w-7xl mx-auto px-6">
        <div className="grid grid-cols-2 md:grid-cols-5 gap-8">
          <div className="col-span-2 md:col-span-1">
            ...
            <p className="mt-3 text-sm opacity-50">{t("hero.badge")}</p>
            ...
            <p className="mt-4 text-xs opacity-40">{t("footer.powered")}</p>
          </div>
        ...
        <div className="mt-12 pt-8 border-t border-border/20 flex flex-col sm:flex-row items-center justify-between gap-4">
          <p className="text-sm opacity-40">{t("footer.rights")}</p>
          <p className="text-xs opacity-30">{t("footer.disclosure")}</p>
        </div>
      </div>
    </footer>
  );
