...
const translations: Record<string, Record<Language, string>> = {
  ...
  // How it works
  "how.title": { en: "Your AI agent. Live in minutes.", de: "Ihr KI-Agent. In Minuten live." },
  "how.subtitle": { en: "No developers needed. No complex setup. Just configure, connect, and go.", de: "Keine Entwickler nötig. Kein komplexes Setup. Einfach konfigurieren, verbinden und loslegen." },
  "how.step1.title": { en: "Choose your AI voice", de: "Wählen Sie Ihre KI-Stimme" },
  ...
  "how.step2.title": { en: "Define what it handles", de: "Definieren Sie die Aufgaben" },
  ...
  "how.step3.title": { en: "Assign a phone number", de: "Telefonnummer zuweisen" },
  ...
  "how.step4.title": { en: "Connect your tools", de: "Verbinden Sie Ihre Tools" },
  ...
  "how.step5.title": { en: "Go live and track results", de: "Live gehen und Ergebnisse verfolgen" },
  ...
  // Use cases
  "uc.title": { en: "What Voxalio handles for you", de: "Was Voxalio für Sie übernimmt" },
  "uc.desc": { en: "From the first ring to the final resolution — Voxalio manages it all, so your team doesn't have to.", de: "Vom ersten Klingeln bis zur finalen Lösung — Voxalio übernimmt alles, damit Ihr Team sich auf Wichtigeres konzentrieren kann." },
  "uc.signup": { en: "Sign up now", de: "Jetzt anmelden" },
  "uc.frontDesk": { en: "Inbound Call Handling", de: "Eingehende Anrufe" },
  ...
  "uc.transcription": { en: "Call Summaries & Notes", de: "Anrufzusammenfassungen" },
  ...
  "uc.customerService": { en: "24/7 Customer Support", de: "24/7 Kundenservice" },
  "uc.customerServiceDesc": { en: "Let our AI handle customer inquiries around the clock. Through our platform, you can precisely configure the AI's responses.", de: "Lassen Sie unsere KI Kundenanfragen rund um die Uhr bearbeiten." },
  "uc.orderProcessing": { en: "Automated Order Intake", de: "Automatisierte Auftragsannahme" },
  ...
  "uc.appointments": { en: "Smart Booking", de: "Intelligente Terminplanung" },
  ...
  "uc.more": { en: "Built for your industry", de: "Für Ihre Branche gebaut" },
  ...
  "faq.q1": { en: "How is Voxalio different from a regular voicebot?", de: "Wie unterscheidet sich Voxalio von einem normalen Voicebot?" },
  "faq.a1": { en: "Unlike basic voicebots that follow rigid scripts, Voxalio uses advanced conversational AI that understands context, handles complex queries, and responds naturally. It integrates with your CRM, calendar, and tools — making it a full AI agent, not just an IVR replacement.", de: "Im Gegensatz zu einfachen Voicebots, die starren Skripten folgen, nutzt Voxalio fortschrittliche konversationelle KI, die Kontext versteht, komplexe Anfragen bearbeitet und natürlich antwortet. Es integriert sich in Ihr CRM, Ihren Kalender und Ihre Tools." },
  "faq.q2": { en: "Which languages does Voxalio support?", de: "Welche Sprachen unterstützt Voxalio?" },
  "faq.a2": { en: "Voxalio currently supports German and English, with more languages coming soon. The AI can detect and switch languages automatically during a call.", de: "Voxalio unterstützt derzeit Deutsch und Englisch, weitere Sprachen folgen bald. Die KI kann Sprachen während eines Anrufs automatisch erkennen und wechseln." },
  "faq.q3": { en: "Is Voxalio GDPR compliant and where is data stored?", de: "Ist Voxalio DSGVO-konform und wo werden Daten gespeichert?" },
  "faq.a3": { en: "Yes. Voxalio is fully GDPR compliant. All data is processed and stored on servers located in Germany. We do not share data with third parties, and every AI call begins with a mandatory disclosure.", de: "Ja. Voxalio ist vollständig DSGVO-konform. Alle Daten werden auf Servern in Deutschland verarbeitet und gespeichert. Wir geben keine Daten an Dritte weiter." },
  ...
  "faq.a7": { en: "Yes! We offer a free Starter plan with 50 minutes per month — no credit card required. You can also request a live demo call right from our homepage to hear Voxalio in action.", de: "Ja! Wir bieten einen kostenlosen Starter-Plan mit 50 Minuten pro Monat — keine Kreditkarte erforderlich. Sie können auch einen Live-Demo-Anruf direkt von unserer Homepage anfordern." },

  // CTA
  "cta.title": { en: "Your phones are ringing. Is anyone answering?", de: "Ihre Telefone klingeln. Nimmt jemand ab?" },
  "cta.desc": { en: "Voxalio picks up every call, qualifies every lead, and books every appointment — while your team focuses on what matters.", de: "Voxalio nimmt jeden Anruf entgegen, qualifiziert jeden Lead und bucht jeden Termin — während Ihr Team sich auf das Wesentliche konzentriert." },
  "cta.button": { en: "Start Free — No Credit Card", de: "Kostenlos starten — Keine Kreditkarte" },
